...
export const WelcomeScreen: React.FC = () => {
  ...
  if (step === 'cover') {
    return (
      <div className="min-h-screen w-full bg-cover bg-center flex items-center justify-center p-4" style={{ backgroundImage: "linear-gradient(rgba(2,6,23,0.66), rgba(30,41,59,0.7)), url(/assets/backgrounds/WelcomeBG.png), url(/assets/backgrounds/welcome-bg.png), url(/assets/backgrounds/welcome-bg.svg)" }}>
  ...
  if (step === 'story') {
    return (
      <div className="min-h-screen w-full bg-cover bg-center flex items-center justify-center p-4" style={{ backgroundImage: "linear-gradient(rgba(30,27,75,0.72), rgba(49,46,129,0.72)), url(/assets/backgrounds/WelcomeBG.png), url(/assets/backgrounds/welcome-bg.png), url(/assets/backgrounds/welcome-bg.svg)" }}>
  ...
  return (
    <div className="min-h-screen w-full bg-cover bg-center flex items-center justify-center p-4" style={{ backgroundImage: "linear-gradient(rgba(49,46,129,0.72), rgba(88,28,135,0.72)), url(/assets/backgrounds/WelcomeBG.png), url(/assets/backgrounds/welcome-bg.png), url(/assets/backgrounds/welcome-bg.svg)" }}>
