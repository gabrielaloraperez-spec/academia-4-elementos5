...
export const MapScreen: React.FC<MapScreenProps> = ({ onLevelSelect, onBossSelect }) => {
  ...
  return (
    <div className="min-h-screen w-full bg-cover bg-center p-4" style={{ backgroundImage: "linear-gradient(rgba(2,6,23,0.74), rgba(30,27,75,0.74)), url(/assets/backgrounds/world-map.svg)" }}>
