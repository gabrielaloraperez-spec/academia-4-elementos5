...
export const kingdomThemes: Record<KingdomOperation, KingdomTheme> = {
  ...
  subtraction: {
    ...
    kingdomName: 'Reino de la Defensa',
    elementName: 'Aire',
    icon: '🌬️',
  ...
  multiplication: {
    ...
    kingdomName: 'Reino de la Construcción',
    elementName: 'Tierra',
    icon: '🪨',
  ...
  division: {
    operation: 'division',
    kingdomName: 'Reino de la Distribución',
    elementName: 'Agua',
    icon: '🌊',
  ...
  time: {
    ...
    elementName: 'Éter',
    icon: '🕰️',
    background: '/assets/backgrounds/knowledge-room.png',
